...
2. **Level 2 (The Cascade Judge):** An automated routing system that identifies highly ambiguous or critical cases ($GCS \le 8$) and invokes a calibrated Support Vector Machine Specialized in medical noise and edge cases.

The system optimizes for the **$F_{1.5}$-Score** to prioritize clinical Sensitivity and minimize the risk of missing critical patients.
